...
const ALL_MODELS = {
  ...
  // ========== MegaLLM ==========
  'gpt-5.1': { provider: 'megallm', name: 'GPT-5.1 (MegaLLM)', envKey: 'MEGALLM_API_KEY', enabled: true },
  
  // MegaLLM - Claude Models
  'claude-sonnet-4-5-20250929': { provider: 'megallm', name: 'Claude Sonnet 4.5 (20250929)', envKey: 'MEGALLM_API_KEY', enabled: true },
  'claude-sonnet-4-20250514': { provider: 'megallm', name: 'Claude Sonnet 4 (20250514)', envKey: 'MEGALLM_API_KEY', enabled: true },
  'claude-opus-4-1-20250805': { provider: 'megallm', name: 'Claude Opus 4.1 (20250805)', envKey: 'MEGALLM_API_KEY', enabled: true },
  'claude-haiku-4-5-20251001': { provider: 'megallm', name: 'Claude Haiku 4.5 (20251001)', envKey: 'MEGALLM_API_KEY', enabled: true },

  // MegaLLM - GPT Models
  'gpt-4.1': { provider: 'megallm', name: 'GPT-4.1', envKey: 'MEGALLM_API_KEY', enabled: true },
  'gpt-5-mini': { provider: 'megallm', name: 'GPT-5 Mini', envKey: 'MEGALLM_API_KEY', enabled: true },
  'gpt-5': { provider: 'megallm', name: 'GPT-5', envKey: 'MEGALLM_API_KEY', enabled: true },
  'gpt-4o-mini': { provider: 'megallm', name: 'GPT-4o Mini', envKey: 'MEGALLM_API_KEY', enabled: true },
  'gpt-3.5-turbo': { provider: 'megallm', name: 'GPT-3.5 Turbo', envKey: 'MEGALLM_API_KEY', enabled: true },
  'gpt-4o': { provider: 'megallm', name: 'GPT-4o', envKey: 'MEGALLM_API_KEY', enabled: true },
  'openai-gpt-oss-120b': { provider: 'megallm', name: 'OpenAI GPT OSS 120B', envKey: 'MEGALLM_API_KEY', enabled: true },

  // MegaLLM - Grok Models
  'grok-4.1-fast-reasoning': { provider: 'megallm', name: 'Grok 4.1 Fast (Reasoning)', envKey: 'MEGALLM_API_KEY', enabled: true },
  'grok-4.1-fast-non-reasoning': { provider: 'megallm', name: 'Grok 4.1 Fast (Non-Reasoning)', envKey: 'MEGALLM_API_KEY', enabled: true },

  // MegaLLM - Moonshot & Qwen Models
  'moonshotai/kimi-k2-instruct-0905': { provider: 'megallm', name: 'Kimi K2 Instruct (0905)', envKey: 'MEGALLM_API_KEY', enabled: true },
  'qwen/qwen3-next-80b-a3b-instruct': { provider: 'megallm', name: 'Qwen3 Next 80B A3B Instruct', envKey: 'MEGALLM_API_KEY', enabled: true },
  'alibaba-qwen3-32b': { provider: 'megallm', name: 'Alibaba Qwen3 32B', envKey: 'MEGALLM_API_KEY', enabled: true },
  'qwen3-coder-480b-a35b-instruct': { provider: 'megallm', name: 'Qwen3 Coder 480B A35B Instruct', envKey: 'MEGALLM_API_KEY', enabled: true },

  // MegaLLM - Gemini Models
  'gemini-2.5-pro': { provider: 'megallm', name: 'Gemini 2.5 Pro', envKey: 'MEGALLM_API_KEY', enabled: true },
};
