  ...
  const pagerPanResponder = useRef(
    PanResponder.create({
      ...
      onPanResponderMove: (_, gs) => {
        ...
        let newValue = baseOffset - gs.dx;
        // Clamp between 0 and SIDEBAR_WIDTH
        newValue = Math.max(0, Math.min(SIDEBAR_WIDTH, newValue));
        scrollX.setValue(newValue);
      },
      onPanResponderRelease: (_, gs) => {
        const baseOffset = currentPage.current === 0 ? 0 : SIDEBAR_WIDTH;
        const currentOffset = baseOffset - gs.dx;
        ...
        const targetOffset = targetPage === 0 ? 0 : SIDEBAR_WIDTH;
  ...
  return (
    <View style={styles.container} {...pagerPanResponder.panHandlers}>
      ...
      >
        ...
        <View style={[styles.sidebarPage, { width: SIDEBAR_WIDTH, paddingTop: insets.top }]}>
        ...
        <View style={[styles.mainPage, { width: SCREEN_WIDTH }]}>
          ...
          <TouchableOpacity 
            style={[styles.floatingMenuBtn, { top: insets.top + 13 }]} 
            onPress={openSidebar}
            activeOpacity={0.7}
          >
