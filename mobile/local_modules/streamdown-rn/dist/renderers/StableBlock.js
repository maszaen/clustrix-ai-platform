 ...
 */
export const StableBlock = React.memo(({ block, theme, componentRegistry }) => {
    // Component blocks don't have AST (custom syntax, not markdown)
    if (block.type === 'component') {
        return (<ComponentBlock block={block} theme={theme} componentRegistry={componentRegistry}/>);
    }
    // Render from cached AST
    if (block.ast) {
        return (<ASTRenderer node={block.ast} theme={theme} componentRegistry={componentRegistry}/>);
    }
...
//# sourceMappingURL=StableBlock.js.map