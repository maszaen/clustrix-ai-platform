...
const markdownStyles = {
  ...
  table: { borderWidth: 1, borderColor: COLORS.borderLight, borderRadius: 4 },
  th: { backgroundColor: COLORS.bgSecondary, padding: 8, borderWidth: 1, borderColor: COLORS.borderLight },
  td: { padding: 8, borderWidth: 1, borderColor: COLORS.borderLight },
};
