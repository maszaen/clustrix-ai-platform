...
export default function SessionList({ sessions, currentSession, onSelect, onDelete, onRename, onToggleFavorite, onNew, onSearchQueryChange, onContextMenuChange }) {
    ...
    <View style={[styles.container, { marginTop: 11 }]}>
      ...
      <View style={styles.headerRow}>
        ...
        <TouchableOpacity style={styles.newChatBtn} onPress={onNew} activeOpacity={0.7}>
          ...
          <View>
            <SvgXml xml={PENCIL} width={23} height={23} style={styles.newChatIcon} />
          </View>
        </TouchableOpacity>
      </View>
